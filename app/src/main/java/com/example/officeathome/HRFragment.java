...
public class HRFragment extends Fragment {
    ...
    public void onStart() {
        ...
        myref.orderByChild("myDep").equalTo("HR").addChildEventListener(mylistener);
    ...
    public void onStop() {
        ...
        myref.orderByChild("myDep").equalTo("HR").removeEventListener(mylistener);
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.search_tab_fragment3, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        t1 = view.findViewById(R.id.HR_table);
